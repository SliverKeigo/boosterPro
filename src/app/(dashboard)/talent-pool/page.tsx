...
import { BoostTable, type BoostColumn, Modal, Popconfirm, Field, MultiFileUpload, SearchSelect, YearSelect, yearOptions, useToast, EllipsisTooltip } from '@/components/ui'
...
export default function TalentPoolPage() {
  ...
  const columns: BoostColumn<any>[] = [
    ...
    { key: 'tags', title: '人才标签', sortable: false,
      ...
      render: (v) => v ? <EllipsisTooltip className="line-clamp-1 max-w-[220px]" content={v} /> : <span className="text-base-content/30">—</span> },
  ...
  return (
    <div>
      ...
      <Modal
        open={open}
        title={mode === 'view' ? '人才详情' : editing ? '编辑人才' : '新建人才'}
