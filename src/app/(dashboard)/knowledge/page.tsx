...
export default function KnowledgePage() {
  ...
  const columns: BoostColumn<any>[] = [
    ...
    },
    {
      ...
      title: '关键词',
      render: (v) =>
        v ? <EllipsisTooltip className="line-clamp-1 max-w-[260px]" content={v} /> : <span className="text-base-content/30">—</span>,
    },
    {
    ...
    { key: 'trainingOutline', title: '培训提纲', defaultVisible: false, render: (v) => v ? <EllipsisTooltip className="line-clamp-1 max-w-[260px]" content={v} /> : <span className="text-base-content/30">—</span> },
