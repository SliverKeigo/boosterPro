...
export default function OpportunitiesPage() {
  ...
  const columns: BoostColumn<any>[] = [
    ...
    // 以下默认隐藏，可在"显示列"开启
    { key: 'description', title: '商机描述', defaultVisible: false, render: (v) => v ? <span className="block max-w-[240px] whitespace-pre-wrap break-words">{v}</span> : '—' },
    { key: 'contactTitle', title: '联系人职务', defaultVisible: false },
    { key: 'contactInfo', title: '联系人电话/EMAIL/微信', defaultVisible: false },
    { key: 'salesDecisionInfo', title: '公司销售决策信息', defaultVisible: false, render: (v) => v ? <span className="block max-w-[240px] whitespace-pre-wrap break-words">{v}</span> : '—' },
    { key: 'customerDecisionMaker', title: '客户决策人', defaultVisible: false },
    { key: 'decisionMakerDescription', title: '决策人信息描述', defaultVisible: false, render: (v) => v ? <span className="block max-w-[240px] whitespace-pre-wrap break-words">{v}</span> : '—' },
