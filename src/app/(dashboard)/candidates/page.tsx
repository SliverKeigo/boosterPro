...
export default function CandidatesPage() {
  ...
  const columns: BoostColumn<any>[] = [
    ...
    { key: 'interviewProgress', title: '面试进展', render: (v) => v ? <span className="block max-w-[200px] whitespace-pre-wrap break-words">{v}</span> : <span className="text-base-content/30">—</span> },
    ...
    { key: 'recommendationReason', title: '推荐理由', defaultVisible: false, render: (v) => v ? <span className="block max-w-[200px] whitespace-pre-wrap break-words">{v}</span> : '—' },
    ...
    { key: 'salaryPlan', title: '薪酬方案', defaultVisible: false, render: (v) => v ? <span className="block max-w-[200px] whitespace-pre-wrap break-words">{v}</span> : '—' },
